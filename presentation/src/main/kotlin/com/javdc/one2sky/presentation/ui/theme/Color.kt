...
val minimumTemperatureLight = Color(0xFF3B608F)
val onMinimumTemperatureLight = Color(0xFFFFFFFF)
val minimumTemperatureContainerLight = Color(0xFFD4E3FF)
val onMinimumTemperatureContainerLight = Color(0xFF001C39)
val maximumTemperatureLight = Color(0xFF904B40)
val onMaximumTemperatureLight = Color(0xFFFFFFFF)
val maximumTemperatureContainerLight = Color(0xFFFFDAD4)
val onMaximumTemperatureContainerLight = Color(0xFF3A0905)

val minimumTemperatureLightMediumContrast = Color(0xFF1B4472)
val onMinimumTemperatureLightMediumContrast = Color(0xFFFFFFFF)
val minimumTemperatureContainerLightMediumContrast = Color(0xFF5276A7)
val onMinimumTemperatureContainerLightMediumContrast = Color(0xFFFFFFFF)
val maximumTemperatureLightMediumContrast = Color(0xFF6E3027)
val onMaximumTemperatureLightMediumContrast = Color(0xFFFFFFFF)
val maximumTemperatureContainerLightMediumContrast = Color(0xFFAA6054)
val onMaximumTemperatureContainerLightMediumContrast = Color(0xFFFFFFFF)

val minimumTemperatureLightHighContrast = Color(0xFF002345)
val onMinimumTemperatureLightHighContrast = Color(0xFFFFFFFF)
val minimumTemperatureContainerLightHighContrast = Color(0xFF1B4472)
val onMinimumTemperatureContainerLightHighContrast = Color(0xFFFFFFFF)
val maximumTemperatureLightHighContrast = Color(0xFF44100A)
val onMaximumTemperatureLightHighContrast = Color(0xFFFFFFFF)
val maximumTemperatureContainerLightHighContrast = Color(0xFF6E3027)
val onMaximumTemperatureContainerLightHighContrast = Color(0xFFFFFFFF)

val minimumTemperatureDark = Color(0xFFA4C9FE)
val onMinimumTemperatureDark = Color(0xFF00315D)
val minimumTemperatureContainerDark = Color(0xFF204876)
val onMinimumTemperatureContainerDark = Color(0xFFD4E3FF)
val maximumTemperatureDark = Color(0xFFFFB4A8)
val onMaximumTemperatureDark = Color(0xFF561E16)
val maximumTemperatureContainerDark = Color(0xFF73342A)
val onMaximumTemperatureContainerDark = Color(0xFFFFDAD4)

val minimumTemperatureDarkMediumContrast = Color(0xFFABCDFF)
val onMinimumTemperatureDarkMediumContrast = Color(0xFF001730)
val minimumTemperatureContainerDarkMediumContrast = Color(0xFF6F93C5)
val onMinimumTemperatureContainerDarkMediumContrast = Color(0xFF000000)
val maximumTemperatureDarkMediumContrast = Color(0xFFFFBAAF)
val onMaximumTemperatureDarkMediumContrast = Color(0xFF330502)
val maximumTemperatureContainerDarkMediumContrast = Color(0xFFCC7B6F)
val onMaximumTemperatureContainerDarkMediumContrast = Color(0xFF000000)

val minimumTemperatureDarkHighContrast = Color(0xFFFBFAFF)
val onMinimumTemperatureDarkHighContrast = Color(0xFF000000)
val minimumTemperatureContainerDarkHighContrast = Color(0xFFABCDFF)
val onMinimumTemperatureContainerDarkHighContrast = Color(0xFF000000)
val maximumTemperatureDarkHighContrast = Color(0xFFFFF9F8)
val onMaximumTemperatureDarkHighContrast = Color(0xFF000000)
val maximumTemperatureContainerDarkHighContrast = Color(0xFFFFBAAF)
val onMaximumTemperatureContainerDarkHighContrast = Color(0xFF000000)
